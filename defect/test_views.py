...
class TestDefectViews(TestCase):
    ...
    def test_render_category_list_page_with_category_form(self):
        ...
        self.assertTemplateUsed(
            response=response,
            template_name="defect/category_list.html")
    ...
    def test_render_log_defect_page_with_defect_form(self):
        ...
        self.assertTemplateUsed(
            response=response,
            template_name="defect/log_defect.html")
        self.assertIsInstance(
    ...
    def test_render_defect_detail_page(self):
        response = self.client.get(reverse(
            'def_detail',
            args=[self.defect.defect_id]))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(
            response=response,
            template_name="defect/defect_detail.html")
        self.assertIsInstance(
